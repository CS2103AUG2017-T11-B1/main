...
public class PersonBuilder {
    ...
    public static final String DEFAULT_EVENT = "Birthday @ 12/06";
    ...
    public PersonBuilder() {
        try {
            ...
            Event defaultEvent = new Event(DEFAULT_EVENT);
            Set<Tag> defaultTags = SampleDataUtil.getTagSet(DEFAULT_TAGS);
            this.person = new Person(defaultName, defaultPhone, defaultEmail, defaultAddress, defaultEvent, defaultTags);
    ...
    public PersonBuilder withEvent(String event) {
        try {
            this.person.setEvent(new Event(event));
        } catch (IllegalValueException ive) {
